...
#define DEF_SYSCALL(name, scn, num_args, ...) \
    { scn, num_args, #name, __VA_ARGS__, &_utee_ ## name },
...
SYSCALL_INFO syscalls[] = {
    ...
    DEF_SYSCALL(panic, TEE_SCN_PANIC, 1, { ARG_VALUE })
    ...
    DEF_SYSCALL(se_service_open, TEE_SCN_SE_SERVICE_OPEN__DEPRECATED, 1, { ARG_HANDLE_OUT_PTR })
    DEF_SYSCALL(se_service_close, TEE_SCN_SE_SERVICE_CLOSE__DEPRECATED, 1, { ARG_HANDLE })
    DEF_SYSCALL(se_service_get_readers, TEE_SCN_SE_SERVICE_GET_READERS__DEPRECATED, 3, { ARG_HANDLE, ARG_BUF_OUT_ADDR | ARG_BUF_LEN_ARG(2), ARG_VALUE_INOUT_PTR })
    DEF_SYSCALL(se_reader_get_prop, TEE_SCN_SE_READER_GET_PROP__DEPRECATED, 2, { ARG_HANDLE, ARG_VALUE_OUT_PTR })
    DEF_SYSCALL(se_reader_get_name, TEE_SCN_SE_READER_GET_NAME__DEPRECATED, 3, { ARG_HANDLE, ARG_BUF_IN_ADDR | ARG_BUF_LEN_ARG(2), ARG_VALUE_INOUT_PTR })
    DEF_SYSCALL(se_reader_open_session, TEE_SCN_SE_READER_OPEN_SESSION__DEPRECATED, 2, { ARG_HANDLE, ARG_HANDLE_OUT_PTR })
    DEF_SYSCALL(se_reader_close_sessions, TEE_SCN_SE_READER_CLOSE_SESSIONS__DEPRECATED, 1, { ARG_HANDLE })
    DEF_SYSCALL(se_session_is_closed, TEE_SCN_SE_SESSION_IS_CLOSED__DEPRECATED, 1, { ARG_HANDLE })
    DEF_SYSCALL(se_session_get_atr, TEE_SCN_SE_SESSION_GET_ATR__DEPRECATED, 3, { ARG_HANDLE, ARG_BUF_OUT_ADDR | ARG_BUF_LEN_ARG(2), ARG_VALUE_INOUT_PTR })
    DEF_SYSCALL(se_session_open_channel, TEE_SCN_SE_SESSION_OPEN_CHANNEL__DEPRECATED, 5, { ARG_HANDLE, ARG_VALUE, ARG_BUF_IN_ADDR | ARG_BUF_LEN_ARG(3), ARG_VALUE, ARG_HANDLE_OUT_PTR })
    DEF_SYSCALL(se_session_close, TEE_SCN_SE_SESSION_CLOSE__DEPRECATED, 1, { ARG_HANDLE })
    DEF_SYSCALL(se_channel_select_next, TEE_SCN_SE_CHANNEL_SELECT_NEXT__DEPRECATED, 1, { ARG_HANDLE })
    DEF_SYSCALL(se_channel_get_select_resp, TEE_SCN_SE_CHANNEL_GET_SELECT_RESP__DEPRECATED, 3, { ARG_HANDLE, ARG_BUF_OUT_ADDR | ARG_BUF_LEN_ARG(2), ARG_VALUE_INOUT_PTR })
    DEF_SYSCALL(se_channel_transmit, TEE_SCN_SE_CHANNEL_TRANSMIT__DEPRECATED, 5, { ARG_HANDLE, ARG_BUF_IN_ADDR | ARG_BUF_LEN_ARG(2), ARG_VALUE, ARG_BUF_OUT_ADDR | ARG_BUF_LEN_ARG(4), ARG_VALUE_INOUT_PTR })
    DEF_SYSCALL(se_channel_close, TEE_SCN_SE_CHANNEL_CLOSE__DEPRECATED, 1, { ARG_HANDLE })
